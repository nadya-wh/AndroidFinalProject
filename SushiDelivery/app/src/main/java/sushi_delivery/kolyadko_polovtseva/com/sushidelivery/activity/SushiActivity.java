...
public class SushiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Food> sushi;
        FoodInitializer foodInitializer = new FoodInitializer(FoodType.SUSHI,
                getResources().openRawResource(R.raw.sushi));

        if (foodInitializer.init()) {
            sushi = foodInitializer.initFoodItems();
            rows = RowModelBuilder.buildRowModel(sushi);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(SushiActivity.this, NewOrderActivity.class));
            }
        });
    }
